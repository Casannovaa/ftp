...
# Installing FTP Tools
yum -y install vsftpd

# Configuration Information Gathering
echo "Basic Configuration will be asked, if you want an exact configuration just configure it yourself"
read -p "Enable anonymous mode? [Y/N] --> " anconf
if [[ $anconf == "Y" ]]
then anon="YES"
elif [[ $anconf == "N" ]]
then anon="NO"
fi
read -p "Use localtime? [Y/N] --> " loconf
if [[ $loconf == "Y" ]]
then loc="YES"
elif [[ $anconf == "N" ]]
then loc="NO"
...
# User permissions for login
read -p "User that will be used for login to FTP --> " ftpuser
